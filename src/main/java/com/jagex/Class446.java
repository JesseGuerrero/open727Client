...
public class Class446 {
    ...
    public static void method7447(String connectionLostText, boolean bool_1, AbstractRenderer graphicsRenderer, FontRenderer fontrenderer_3, FontMetrics fontmetrics_4) {
        ...
        if (bool_6) {
            ...
            if (Class174.aBool2135 && bool_6) {
                ...
                fontrenderer_31 = graphicsRenderer.createFont(fontmetrics_41, Class174.aClass91Array2132, true);
                i_7 = fontmetrics_41.method6951(connectionLostText, 250, null);
                i_8 = fontmetrics_41.method6972(connectionLostText, 250, fontmetrics_41.verticalSpacing, null);
                ...
                graphicsRenderer.method8444(QuestIndexLoader.aClass91_2981, false).method2772(i_11 + Class174.aClass91_2141.width, i_12 + Class174.aClass91_2141.height, i_7 - Class174.aClass91_2141.width * 2, i_8 - Class174.aClass91_2141.height * 2, 1, 0, 0);
                graphicsRenderer.method8444(Class174.aClass91_2141, true).method2752(i_11, i_12);
                Class174.aClass91_2141.method1525();
                graphicsRenderer.method8444(Class174.aClass91_2141, true).method2752(i_7 + i_11 - i_15, i_12);
                Class174.aClass91_2141.method1526();
                graphicsRenderer.method8444(Class174.aClass91_2141, true).method2752(i_7 + i_11 - i_15, i_8 + i_12 - i_15);
                Class174.aClass91_2141.method1525();
                graphicsRenderer.method8444(Class174.aClass91_2141, true).method2752(i_11, i_8 + i_12 - i_15);
                Class174.aClass91_2141.method1526();
                graphicsRenderer.method8444(Class174.aClass91_2138, true).method2756(i_11, i_12 + Class174.aClass91_2141.height, i_15, i_8 - Class174.aClass91_2141.height * 2);
                Class174.aClass91_2138.method1527();
                graphicsRenderer.method8444(Class174.aClass91_2138, true).method2756(i_11 + Class174.aClass91_2141.width, i_12, i_7 - Class174.aClass91_2141.width * 2, i_15);
                Class174.aClass91_2138.method1527();
                graphicsRenderer.method8444(Class174.aClass91_2138, true).method2756(i_11 + i_7 - i_15, i_12 + Class174.aClass91_2141.height, i_15, i_8 - Class174.aClass91_2141.height * 2);
                Class174.aClass91_2138.method1527();
                graphicsRenderer.method8444(Class174.aClass91_2138, true).method2756(i_11 + Class174.aClass91_2141.width, i_8 + i_12 - i_15, i_7 - Class174.aClass91_2141.width * 2, i_15);
                Class174.aClass91_2138.method1527();
                fontrenderer_31.method378(connectionLostText, i_11 + i_10, i_12 + i_10, i_7 - i_10 * 2, i_8 - i_10 * 2, Class434.anInt5329 | -16777216, -1, 1, 1, 0, null, null, null, 0, 0);
                Class292.method5201(i_11, i_12, i_7, i_8);
            } else {
                i_7 = fontmetrics_41.method6951(connectionLostText, 250, null);
                i_8 = fontmetrics_41.method6949(connectionLostText, 250, null) * 13;
                byte b_9 = 4;
                i_10 = b_9 + 6;
                i_11 = b_9 + 6;
                graphicsRenderer.B(i_10 - b_9, i_11 - b_9, b_9 + i_7 + b_9, i_8 + b_9 + b_9, -16777216, 0);
                graphicsRenderer.method8430(i_10 - b_9, i_11 - b_9, b_9 + i_7 + b_9, b_9 + i_8 + b_9, -1, 0);
                fontrenderer_31.method378(connectionLostText, i_10, i_11, i_7, i_8, -1, -1, 1, 1, 0, null, null, null, 0, 0);
                Class292.method5201(i_10 - b_9, i_11 - b_9, b_9 + i_7 + b_9, b_9 + i_8 + b_9);
            }
            if (bool_1) {
                try {
                    graphicsRenderer.method8393();
