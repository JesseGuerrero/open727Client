...
public class Loader extends Applet implements AppletStub {
    ...
    public static final int WORLD_PORT = 43594;
    public static final int LOBBY_PORT = 43594;
    public static final int LOBBY_WORLD = 1115;
    public static final int JS5_SOURCE_WORLD = 177;
    public static final int DEFAULT_WORLD = 1;
    public static final BigInteger RSA_PUBLIC_MODULUS = new BigInteger("");
    ...
    public static boolean ENABLE_USELESS_PACKETS = true;
